...
/* Incremental API types expected by m4fstack */
...
/* Incremental API declarations expected by m4fstack */
...
void shake128_inc_squeezeblocks(uint8_t *out, size_t nblocks, shake128incctx *state);
...
void shake256_inc_squeezeblocks(uint8_t *out, size_t nblocks, shake256incctx *state);
